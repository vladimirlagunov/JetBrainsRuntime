...
#include "sun_awt_wl_WLInputMethodDescriptor.h"
#include "sun_awt_wl_WLInputMethod.h"
...
static struct
{
    ...
    /// `sun.awt.wl.WLInputMethod#zwp_text_input_v3_onEnter`
    jmethodID mID_tiOnEnter;
    /// `sun.awt.wl.WLInputMethod#zwp_text_input_v3_onLeave`
    jmethodID mID_tiOnLeave;
    /// `sun.awt.wl.WLInputMethod#zwp_text_input_v3_onPreeditString`
    jmethodID mID_tiOnPreeditString;
    /// `sun.awt.wl.WLInputMethod#zwp_text_input_v3_onCommitString`
    jmethodID mID_tiOnCommitString;
    /// `sun.awt.wl.WLInputMethod#zwp_text_input_v3_onDeleteSurroundingText`
    jmethodID mID_tiOnDeleteSurroundingText;
    /// `sun.awt.wl.WLInputMethod#zwt_text_input_v3_onDone`
...
/**
 * The native-side counterpart of `sun.awt.wl.WLInputMethod`.
 ...
 *
 * `IMContext` and `WLInputMethod` are related in a 1:1 ratio - an instance of `WLInputMethod` holds no more than 1
 * instance of `IMContext` and an instance of `IMContext` only belongs to 1 instance of `WLInputMethod`.
 */
struct IMContext
{
    /// A global reference to the instance of `sun.awt.wl.WLInputMethod` owning this instance of `IMContext`.
 ...
 *
 * @param wlInputMethodOwnerRefToCopy a reference to the owning instance of `sun.awt.wl.WLInputMethod`.
...
static struct IMContext* IMContext_Create(JNIEnv * const env, jobject wlInputMethodOwnerRefToCopy)
{
    ...
    //   the constructor of `sun.awt.wl.WLInputMethod` finishes (because the constructor gets called on the
    ...
    //   `WLInputMethod` class in general.
...
// `WLInputMethod`'s JNI upcalls as possible in terms of contained logic.
...
Java_sun_awt_wl_WLInputMethodDescriptor_checkIfAvailableOnPlatform(JNIEnv * const env, const jclass)
{
...
Java_sun_awt_wl_WLInputMethod_initIDs(JNIEnv * const env, const jclass clazz)
{
    CHECK_NULL_THROW_OOME(
        env,
        jniIDs.wlInputMethodClass = (*env)->NewGlobalRef(env, clazz),
        "Allocation of a global reference to sun.awt.wl.WLInputMethod class failed"
    );
...
Java_sun_awt_wl_WLInputMethod_createNativeContext(JNIEnv * const env, const jobject self)
{
    struct IMContext *result = NULL;

    if (!checkIfTheImplementationIsAvailable())
    {
        JNU_ThrowByName(env, "java/awt/AWTException", "sun.awt.wl.WLInputMethod does not support this system");
        return 0;
    }
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_disposeNativeContext(
    JNIEnv * const env,
    const jclass,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_zwp_1text_1input_1v3_1enable(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr
) {
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_zwp_1text_1input_1v3_1disable(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr
) {
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_zwp_1text_1input_1v3_1set_1cursor_1rectangle(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_zwp_1text_1input_1v3_1set_1content_1type(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr,
    const jint hint,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_zwp_1text_1input_1v3_1set_1text_1change_1cause(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLInputMethod_zwp_1text_1input_1v3_1commit(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr
) {
